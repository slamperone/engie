...
<div style="width: 600px; padding: 0 0 60px 0; border-bottom: 3px solid #F5BA27;">	
    ...
    <p style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'">Tu numero de folio es: <b>{{ $folio }}</b>, debes conservarlo para canjear tu premio, recuerda que los ganadores serán dados a conocer el día 15 de julio del presente año. <br />Al ser este un email de confirmación, no es necesario que lo respondas.</p>
